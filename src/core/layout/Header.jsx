...
import { SOFTWARE_MODULE_OPTIONS } from "../config/softwareModules.js";
  ...
  return (
    <header className="fixed top-0 left-0 z-50 flex w-full items-center justify-between bg-white px-4 py-1.5 font-sans text-xs text-gray-700 shadow-md h-[30px]">
      ...
      <div className="flex min-w-0 items-center gap-2">
        ...
        <span className="text-gray-400 shrink-0">·</span>
        <span
          className="hidden sm:inline rounded border border-gray-200 bg-gray-50 px-1.5 py-0 text-[10px] font-medium text-gray-600"
          title="Software type selected at login"
        >
          {softwareModuleLabel}
        </span>
      </div>
