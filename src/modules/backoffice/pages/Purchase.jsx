...
import SaleIcon from '../../../shared/assets/icons/sales.svg';
import { InputField, SubInputField, DropdownInput, DateInputField, Switch, CommonTable, ConfirmDialog } from '../../../shared/components/ui';
  ...
  return (
    <div className="mb-2 mt-0 flex w-full min-w-0 flex-col px-1 sm:mb-[15px] sm:mt-0 sm:-mx-[13px] sm:w-[calc(100%+26px)] sm:max-w-none sm:px-0">
      ...
      <ConfirmDialog
        ...
        message="This will remove the row from the purchase. This action cannot be undone."
        confirmLabel="Delete"
        cancelLabel="Cancel"
        danger
