...
const SAMPLE_FOLLOWUPS = [
  { id: 1,  dueDate: '2026-04-22', time: '09:00', subject: 'Discuss renewal terms',    linkedType: 'Customer',     linkedName: 'Al Noor Trading',     priority: 'High',   status: 'Overdue',   assignedTo: 'Sabeeh',  mode: 'Call' },
  { id: 2,  dueDate: '2026-04-22', time: '11:30', subject: 'Send product catalogue',   linkedType: 'Lead',         linkedName: 'Blue Star Garage',    priority: 'Medium', status: 'Overdue',   assignedTo: 'Swetha',  mode: 'Email' },
  { id: 3,  dueDate: '2026-04-23', time: '10:00', subject: 'Demo walkthrough call',    linkedType: 'Opportunity',  linkedName: 'Gulf Auto Parts',     priority: 'High',   status: 'Pending',   assignedTo: 'Sabeeh',  mode: 'Call' },
  { id: 4,  dueDate: '2026-04-23', time: '14:00', subject: 'Proposal follow-up',       linkedType: 'Lead',         linkedName: 'TechWave Solutions',  priority: 'High',   status: 'Pending',   assignedTo: 'Sonu',    mode: 'Email' },
  { id: 5,  dueDate: '2026-04-23', time: '15:30', subject: 'Confirm meeting slot',     linkedType: 'Customer',     linkedName: 'Prime Logistics',     priority: 'Low',    status: 'Pending',   assignedTo: 'Swetha',  mode: 'Meeting' },
  { id: 6,  dueDate: '2026-04-24', time: '09:30', subject: 'Quarterly review prep',    linkedType: 'Customer',     linkedName: 'Al Rawabi Group',     priority: 'Medium', status: 'Pending',   assignedTo: 'Sabeeh',  mode: 'Meeting' },
  { id: 7,  dueDate: '2026-04-24', time: '12:00', subject: 'Budget discussion',        linkedType: 'Opportunity',  linkedName: 'Skyline Contracting', priority: 'High',   status: 'Pending',   assignedTo: 'Swetha',  mode: 'Call' },
  { id: 8,  dueDate: '2026-04-25', time: '10:00', subject: 'Site visit scheduling',    linkedType: 'Lead',         linkedName: 'Falcon Industries',   priority: 'Medium', status: 'Pending',   assignedTo: 'Sonu',    mode: 'Visit' },
  { id: 9,  dueDate: '2026-04-27', time: '11:00', subject: 'Contract finalisation',    linkedType: 'Opportunity',  linkedName: 'Horizon Real Estate', priority: 'High',   status: 'Pending',   assignedTo: 'Sabeeh',  mode: 'Meeting' },
  { id: 10, dueDate: '2026-04-29', time: '14:30', subject: 'Check payment status',     linkedType: 'Customer',     linkedName: 'Nova Electronics',    priority: 'Low',    status: 'Cancelled', assignedTo: 'Swetha',  mode: 'Email' },
];
...
// ─── Main Page ────────────────────────────────────────────────────────────────
const FOLLOW_COL_PCT = [10, 8, 20, 16, 8, 10, 12, 10, 6];
