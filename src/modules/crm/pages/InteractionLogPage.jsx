...
const SAMPLE_INTERACTIONS = [
  { id: 1,  date: '2026-04-22', time: '09:15', type: 'Call',     mode: 'Outbound',  subject: 'Initial qualification call',        linkedType: 'Lead',        linkedName: 'Blue Star Garage',    summary: 'Discussed product requirements and pricing expectations. Customer showed interest in annual contract.', outcome: 'Positive',     nextAction: 'Send proposal by 25 Apr', by: 'Sabeeh' },
  { id: 2,  date: '2026-04-22', time: '10:45', type: 'Email',    mode: 'Outbound',  subject: 'Product catalogue shared',          linkedType: 'Lead',        linkedName: 'TechWave Solutions',  summary: 'Sent full product catalogue and pricing sheet. Requested confirmation of receipt.', outcome: 'Neutral',      nextAction: 'Follow up if no reply by 24 Apr', by: 'Swetha' },
  ...
  { id: 4,  date: '2026-04-23', time: '09:00', type: 'Call',     mode: 'Inbound',   subject: 'Support enquiry on order #5021',    linkedType: 'Customer',    linkedName: 'Prime Logistics',     summary: 'Customer called regarding delay in delivery. Escalated to operations team for resolution.', outcome: 'Negative',     nextAction: 'Confirm delivery date by EOD', by: 'Sonu' },
  { id: 5,  date: '2026-04-23', time: '11:30', type: 'Demo',     mode: 'Outbound',  subject: 'ERP demo – Finance module',         linkedType: 'Opportunity', linkedName: 'Gulf Auto Parts',     summary: 'Conducted live demo of finance and procurement modules. Positive reception from CFO.', outcome: 'Positive',     nextAction: 'Share ROI document', by: 'Swetha' },
  { id: 6,  date: '2026-04-23', time: '13:00', type: 'Visit',    mode: 'Outbound',  subject: 'On-site needs assessment',          linkedType: 'Lead',        linkedName: 'Falcon Industries',   summary: 'Visited warehouse and assessed current manual processes. Identified 3 automation opportunities.', outcome: 'Positive',     nextAction: 'Draft solution proposal', by: 'Sabeeh' },
  ...
  { id: 8,  date: '2026-04-21', time: '16:30', type: 'WhatsApp', mode: 'Outbound',  subject: 'Quick update on contract status',   linkedType: 'Opportunity', linkedName: 'Horizon Real Estate', summary: 'Sent WhatsApp message to procurement head with contract summary PDF.', outcome: 'No Response',  nextAction: 'Call if no reply by 24 Apr', by: 'Sonu' },
  { id: 9,  date: '2026-04-20', time: '10:00', type: 'Email',    mode: 'Inbound',   subject: 'Customer complaint – billing error', linkedType: 'Customer',   linkedName: 'Nova Electronics',    summary: 'Received email regarding a billing discrepancy of AED 1,200. Referred to accounts team.', outcome: 'Negative',     nextAction: 'Issue credit note', by: 'Swetha' },
  { id: 10, date: '2026-04-20', time: '11:15', type: 'Meeting',  mode: 'Outbound',  subject: 'Partnership discussion',            linkedType: 'Customer',    linkedName: 'Al Rawabi Group',     summary: 'Met with GM to discuss potential distribution partnership for new product line in the Northern region.', outcome: 'Positive', nextAction: 'Draft MOU for review', by: 'Sabeeh' },
];
