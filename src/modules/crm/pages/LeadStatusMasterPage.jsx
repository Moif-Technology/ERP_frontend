...
export default function LeadStatusMasterPage() {
  ...
  /* ── table ── */
  const headers = ['#', 'Status Name', 'Color', 'Description', 'Order', 'Active', 'Action'];
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-sm font-bold tracking-wide text-gray-800">LEAD STATUS MASTER</h1>
      ...
      <div className="rounded-lg bg-white shadow-sm">
        <CommonTable
          ...
          rows={tableRows}
          fitParentWidth
          columnWidthPercents={[4, 14, 14, 36, 7, 9, 8]}
