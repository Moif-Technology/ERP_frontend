...
const SAMPLE_DATA = [
  { id: 1, oppNo: 'OPP-0001', customer: 'Al Noor Trading LLC', title: 'ERP + POS Implementation', stage: 'Proposal', value: 285000, closeDate: '2026-05-30', assignedTo: 'Sabeeh', probability: 60 },
  { id: 2, oppNo: 'OPP-0002', customer: 'Gulf Star Automotive', title: 'Garage Management System', stage: 'Qualified', value: 140000, closeDate: '2026-06-15', assignedTo: 'Swetha', probability: 40 },
  { id: 3, oppNo: 'OPP-0003', customer: 'Masdar Trading Co.', title: 'Inventory & Accounting Suite', stage: 'Negotiation', value: 320000, closeDate: '2026-05-10', assignedTo: 'Sonu', probability: 75 },
  { id: 4, oppNo: 'OPP-0004', customer: 'Al Baraka Retail', title: 'Retail POS Rollout – 5 Branches', stage: 'Won', value: 195000, closeDate: '2026-04-01', assignedTo: 'Sabeeh', probability: 100 },
  { id: 5, oppNo: 'OPP-0005', customer: 'Emirates Gate Group', title: 'HR & Payroll Module', stage: 'Prospect', value: 75000, closeDate: '2026-07-20', assignedTo: 'Swetha', probability: 20 },
  { id: 6, oppNo: 'OPP-0006', customer: 'Rimal Foodstuff LLC', title: 'Supply Chain & Distribution', stage: 'Lost', value: 210000, closeDate: '2026-03-15', assignedTo: 'Sonu', probability: 0 },
  { id: 7, oppNo: 'OPP-0007', customer: 'Blue Falcon Engineering', title: 'Project Costing Module', stage: 'Proposal', value: 98000, closeDate: '2026-06-01', assignedTo: 'Sabeeh', probability: 55 },
  { id: 8, oppNo: 'OPP-0008', customer: 'Al Waha Auto Parts', title: 'Spare Parts Inventory ERP', stage: 'Qualified', value: 162000, closeDate: '2026-06-30', assignedTo: 'Swetha', probability: 45 },
  { id: 9, oppNo: 'OPP-0009', customer: 'Zayed Contracting LLC', title: 'Construction ERP Full Suite', stage: 'Negotiation', value: 480000, closeDate: '2026-05-20', assignedTo: 'Sonu', probability: 80 },
  { id: 10, oppNo: 'OPP-0010', customer: 'Pearl Coast Trading', title: 'CRM + Sales Module', stage: 'Won', value: 110000, closeDate: '2026-04-10', assignedTo: 'Sabeeh', probability: 100 },
];
...
export default function OpportunityListPage() {
  ...
  const tableBodyRows = filteredRows.map((row) => [
    ...
    <div key={`actions-${row.id}`} className="flex items-center justify-center gap-1.5 whitespace-nowrap">
      ...
      <button
        type="button"
        onClick={() => navigate(`/crm/opportunity-entry?id=${row.id}`)}
        className="flex h-7 w-7 items-center justify-center rounded bg-white hover:bg-gray-50"
        title="Edit"
      >
