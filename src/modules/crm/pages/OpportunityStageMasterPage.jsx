...
export default function OpportunityStageMasterPage() {
  ...
  /* ── table ── */
  const headers = ['#', 'Stage Name', 'Color', 'Probability %', 'Description', 'Order', 'Active', 'Action'];
  ...
  const tableRows = rows.map((row, idx) => [
    ...
    <span className="flex items-center gap-1.5">
      ...
      />
      <span className="font-mono text-[10px] text-gray-600">{row.color_code}</span>
    </span>,
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-sm font-bold tracking-wide text-gray-800">OPPORTUNITY STAGE MASTER</h1>
      ...
      <div className="rounded-lg bg-white shadow-sm">
        <CommonTable
          ...
          rows={tableRows}
          fitParentWidth
          columnWidthPercents={[4, 12, 13, 10, 33, 6, 8, 8]}
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            ...
            <div className="space-y-3">
              ...
              {/* Color Code */}
              <div>
                <label className="mb-1 block text-[11px] font-medium text-gray-700">Color Code</label>
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    placeholder="#60A5FA"
                    maxLength={7}
                    className="w-28 rounded border border-gray-200 px-2.5 py-1.5 font-mono text-xs outline-none focus:border-gray-400"
                  />
                </div>
              </div>
              ...
              {form.stage_name && (
                <div className="flex items-center gap-2 rounded bg-gray-50 px-3 py-2">
                  ...
                  >
                    {form.stage_name}
                    {form.probability_percent !== '' ? ` · ${form.probability_percent}%` : ''}
                  </span>
                </div>
              )}
            </div>
