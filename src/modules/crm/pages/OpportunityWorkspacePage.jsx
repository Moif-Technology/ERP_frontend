...
const SAMPLE_INTERACTIONS = [
  { id: 1, date: '2026-04-15', type: 'Meeting', mode: 'In-Person', subject: 'Product demo walkthrough', outcome: 'Client impressed, requested pricing', by: 'Sonu' },
  { id: 2, date: '2026-04-10', type: 'Call', mode: 'Phone', subject: 'Follow-up on proposal', outcome: 'Awaiting internal approval', by: 'Swetha' },
  { id: 3, date: '2026-04-05', type: 'Email', mode: 'Email', subject: 'Sent detailed proposal doc', outcome: 'Delivered', by: 'Sonu' },
  { id: 4, date: '2026-03-28', type: 'Call', mode: 'Video', subject: 'Initial requirements gathering', outcome: 'Noted all requirements', by: 'Sabeeh' },
  { id: 5, date: '2026-03-20', type: 'Meeting', mode: 'In-Person', subject: 'First meeting', outcome: 'Interest confirmed', by: 'Sonu' },
];

const SAMPLE_FOLLOWUPS = [
  { id: 1, dueDate: '2026-04-25', subject: 'Submit revised commercial offer', assignedTo: 'Sonu', priority: 'High', status: 'Pending' },
  { id: 2, dueDate: '2026-04-28', subject: 'Legal contract review call', assignedTo: 'Swetha', priority: 'High', status: 'Pending' },
  { id: 3, dueDate: '2026-05-02', subject: 'Site visit for implementation planning', assignedTo: 'Sabeeh', priority: 'Medium', status: 'Scheduled' },
  { id: 4, dueDate: '2026-05-05', subject: 'Confirm go-live date', assignedTo: 'Sonu', priority: 'Medium', status: 'Pending' },
  { id: 5, dueDate: '2026-04-20', subject: 'Send module feature comparison', assignedTo: 'Swetha', priority: 'Low', status: 'Completed' },
];

const SAMPLE_NOTES = [
  { id: 1, title: 'Key Decision Maker', body: 'Ahmed Al Zaabi is the main decision maker. Finance director Khalid must also sign off.', createdBy: 'Sonu', createdDate: '2026-04-12' },
  { id: 2, title: 'Budget Constraint', body: 'Client has budget ceiling of ₹3.5L. May need to phase the rollout across two financial years.', createdBy: 'Swetha', createdDate: '2026-04-08' },
  { id: 3, title: 'Competitor Info', body: 'Competing against SAP B1 quote. Ours is 40% lower. Highlight localisation and support.', createdBy: 'Sabeeh', createdDate: '2026-04-02' },
  { id: 4, title: 'Implementation Timeline', body: 'Requested go-live by 1st August 2026. Feasible if PO signed by May end.', createdBy: 'Sonu', createdDate: '2026-03-25' },
];

const SAMPLE_STAGE_HISTORY = [
  { id: 1, stage: 'Prospect',    changedBy: 'Sabeeh', date: '2026-03-15', remarks: 'Initial opportunity created from lead LD-0003' },
  { id: 2, stage: 'Qualified',   changedBy: 'Sabeeh', date: '2026-03-20', remarks: 'Budget and authority confirmed' },
  { id: 3, stage: 'Proposal',    changedBy: 'Sonu',   date: '2026-04-05', remarks: 'Detailed proposal submitted via email' },
  { id: 4, stage: 'Negotiation', changedBy: 'Sonu',   date: '2026-04-15', remarks: 'Commercial discussions underway' },
];
