...
const substituteDummyRows = [
  { productCode: 'PRD-1001', productName: 'Widget bolt M8', unitPrice: '18.50' },
  { productCode: 'PRD-2044', productName: 'Rubber gasket set', unitPrice: '9.25' },
  { productCode: 'PRD-3300', productName: 'Steel bracket 120mm', unitPrice: '42.00' },
];
...
export default function ProductEntry() {
  ...
  const formatSubstituteUnitPrice = (v) => {
  ...
  const handleAddSubstitute = () => {
    ...
    setSubstituteRows((prev) => [
      ...prev,
      {
        productCode: code || '-',
        productName: name || '-',
        unitPrice: formatSubstituteUnitPrice(searchUnitPrice),
      },
    ]);
    setSearchName('');
    setSearchCode('');
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                      ...
                      <div className="flex min-w-0 flex-col justify-end gap-0.5">
                        ...
                        <div className="flex min-h-[20.08px] items-center gap-2">
                          <Switch checked={main.newBarcode} onChange={(v) => setMain((m) => ({ ...m, newBarcode: v }))} />
              ...
              <div className="flex min-h-0 min-w-0 flex-1 flex-col gap-3">
                ...
                <div className={`${fieldBox} flex min-h-0 flex-1 flex-col gap-2 sm:gap-3`}>
                  ...
                  <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-end sm:gap-2">
                    ...
                    <div className="min-w-0 w-full sm:w-[6.5rem] sm:flex-none sm:shrink-0">
                      <SubInputField
                        label="Unit price"
                        type="number"
                        fullWidth
                  ...
                  <div className="min-h-0 w-full min-w-0 flex-1">
                    <CommonTable
                      ...
                      equalColumnWidth
                      maxVisibleRows={8}
                      headers={['Product code', 'Product name', 'Unit price', '']}
