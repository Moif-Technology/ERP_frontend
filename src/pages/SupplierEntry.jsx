...
import { DropdownInput, InputField, SubInputField } from '../components/ui';
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="mt-3 flex justify-center">
        <div className="w-full max-w-4xl rounded border border-gray-200 bg-white p-3 shadow-sm sm:p-4">
